...
The bundled labeled fixture currently reports 52/52 exact overall statuses, 0 false `READY` results among 45 expected non-`READY` cases, 12 `NEEDS_REVIEW` results (23.1%), and 42 combined abstentions (80.8%). These are fixture-scoped regression results, not estimates of behavior on external or real-world notes.
