...
2. Add one more supported procedure only if it can stay as deterministic and auditable as the current four.
...
Those ideas would widen scope without improving the validated deterministic core.
